...
- **Edit request (add feedback):** Provide guidance to redirect the AI's approach
- **Cancel:** Abort execution

The **Edit request** option allows you to provide specific feedback when the proposed action isn't quite right. Your feedback is sent to the AI, which will adjust its approach accordingly. See [Edit Request with Feedback](../features/edit-request-feedback.md) for more details.
