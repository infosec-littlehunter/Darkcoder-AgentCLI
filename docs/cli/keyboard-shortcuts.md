...
| Shortcut  | Description                                          |
| --------- | ---------------------------------------------------- |
| `↑` / `k` | Move selection up through confirmation options.      |
| `↓` / `j` | Move selection down through confirmation options.    |
| `Enter`   | Confirm the selected option.                         |
| `Esc`     | Cancel the operation (equivalent to selecting "No"). |
| `Ctrl+C`  | Cancel the operation.                                |

### Edit Request Mode

When "Edit request (add feedback)" is selected:

| Shortcut | Description                                             |
| -------- | ------------------------------------------------------- |
| `Enter`  | Submit feedback and redirect the AI with your guidance. |
| `Esc`    | Cancel edit mode and return to confirmation options.    |
