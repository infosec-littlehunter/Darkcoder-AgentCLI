...
const PATTERNS: Array<[RegExp, TokenCount]> = [
  ...
  // -------------------
  // OpenAI (o1 / o3 / chatgpt / gpt-4o family)
  // o1 and o3 document a 200,000-token context window (decimal).
  // chatgpt-4o-latest and gpt-4o use 128k context window.
  [/^chatgpt-4o.*$/, LIMITS['128k']],
  [/^o1(?:-mini|-preview)?.*$/, LIMITS['200k']],
  [/^o3(?:-mini)?.*$/, LIMITS['200k']],
  [/^o4-mini.*$/, LIMITS['200k']],
...
const OUTPUT_PATTERNS: Array<[RegExp, TokenCount]> = [
  ...
  // Deepseek-reasoner: 128k max tokens
  [/^deepseek-reasoner$/, LIMITS['128k']],
];
