 ...
 * Lowered from 0.7 to 0.5 for more aggressive compression to prevent
 * "maximum context length exceeded" errors.
 */
export const COMPRESSION_TOKEN_THRESHOLD = 0.5;

/**
 * The fraction of the latest chat history to keep. A value of 0.2
 * means that only the last 20% of the chat history will be kept after compression.
 * Lowered from 0.3 to 0.2 for more aggressive context reduction.
 */
export const COMPRESSION_PRESERVE_THRESHOLD = 0.2;
