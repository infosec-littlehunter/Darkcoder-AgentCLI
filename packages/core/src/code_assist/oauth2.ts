...
const OAUTH_CLIENT_SECRET = 'YOUR_OAUTH_CLIENT_SECRET'; // Replace with actual secret if needed or follow GitHub link to allow.
...
export async function clearCachedCredentialFile() {
  try {
     ...
     */
    try {
      const { SharedTokenManager } =
        await import('../qwen/sharedTokenManager.js');
