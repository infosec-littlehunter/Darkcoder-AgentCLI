...
import type { Config, ToolCallRequestInfo } from '@darkcoder/darkcoder-core';
...
import {
  ...
  // handleMaxTurnsExceededError - removed: turn limits disabled
...
export async function runNonInteractive(
  ...
  return promptIdContext.run(prompt_id, async () => {
    ...
    try {
      ...
      while (true) {
        turnCount++;
        // Note: Session turn limit enforcement removed - LLM completes tasks without artificial limits
