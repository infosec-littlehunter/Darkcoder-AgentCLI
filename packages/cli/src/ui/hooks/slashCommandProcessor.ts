...
export const useSlashCommandProcessor = (
  ...
  const addMessage = useCallback(
    (message: Message) => {
      ...
      } else if (message.type === MessageType.COST_STATS) {
        historyItemContent = {
          type: 'cost_stats',
        };
              ...
              switch (result.type) {
                ...
                case 'dialog':
                  switch (result.dialog) {
                    ...
                    case 'provider':
                      ...
                      return { type: 'handled' };
                    case 'provider_keys':
                      actions.openProviderKeysDialog();
                      return { type: 'handled' };
                    case 'security_tools':
                      actions.openSecurityToolsDialog();
                      return { type: 'handled' };
                    case 'permissions':
                ...
                case 'confirm_shell_commands': {
                  ...
                  if (
                    ...
                    // User feedback (_feedback) is available here for future use
                    // when we implement feedback-based command regeneration
                    return { type: 'handled' };
                  }
