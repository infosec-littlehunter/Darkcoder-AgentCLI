...
import { isCommandAvailable, execCommand } from '@darkcoder/darkcoder-core';

// Mock @darkcoder/darkcoder-core
vi.mock('@darkcoder/darkcoder-core', async () => {
  const original = await vi.importActual<
    typeof import('@darkcoder/darkcoder-core')
  >('@darkcoder/darkcoder-core');
  return {
    ...original,
    execCommand: vi.fn(),
