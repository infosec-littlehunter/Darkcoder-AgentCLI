...
import { CostStatsDisplay } from './CostStatsDisplay.js';
import { SessionSummaryDisplay } from './SessionSummaryDisplay.js';
import { Help } from './Help.js';
import type { SlashCommand } from '../commands/types.js';
import { ExtensionsList } from './views/ExtensionsList.js';
import { getMCPServerStatus } from '@darkcoder/darkcoder-core';
...
const HistoryItemDisplayComponent: React.FC<HistoryItemDisplayProps> = ({
  ...
  return (
    <Box flexDirection="column" key={itemForDisplay.id}>
      ...
      {itemForDisplay.type === 'cost_stats' && <CostStatsDisplay />}
