...
import { ProviderKeysDialog } from './ProviderKeysDialog.js';
import { SecurityToolsDialog } from './SecurityToolsDialog.js';
...
import { AuthType, PROVIDER_PRESETS } from '@darkcoder/darkcoder-core';
...
export const DialogManager = ({
  ...
  if (uiState.isProviderKeysDialogOpen) {
    return <ProviderKeysDialog onClose={uiActions.closeProviderKeysDialog} />;
  }
  if (uiState.isSecurityToolsDialogOpen) {
    return <SecurityToolsDialog onClose={uiActions.closeSecurityToolsDialog} />;
  }
