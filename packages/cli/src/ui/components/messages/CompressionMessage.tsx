...
import { CompressionStatus } from '@darkcoder/darkcoder-core';
    ...
    switch (compressionStatus) {
      ...
      case CompressionStatus.COMPRESSION_FAILED_INFLATED_TOKEN_COUNT:
        ...
        if (originalTokens < 50000) {
          return t('History too small to compress effectively.');
        }
        // For larger histories where compression should work but didn't,
        // this suggests an issue with the compression process itself
        return t('Compression did not reduce size.');
      case CompressionStatus.COMPRESSION_FAILED_TOKEN_COUNT_ERROR:
        return t('Compression failed: token counting error.');
