...
const SETTINGS_SCHEMA = {
  ...
  ui: {
    ...
    properties: {
      ...
      hideBanner: {
        ...
        default: true,
        description:
          'Hide the application banner (Python banner shows before CLI starts)',
        showInDialog: true,
      },
      hideContextSummary: {
        type: 'boolean',
  ...
  model: {
    ...
    properties: {
      ...
      disableTools: {
        type: 'boolean',
        label: 'Disable Tool Calling',
        category: 'Model',
        requiresRestart: false,
        default: false,
        description:
          'Disable tool/function calling for models that do not support it. When enabled, runs in basic chat mode without file editing or code execution capabilities.',
        showInDialog: true,
      },
      maxOutputTokens: {
        type: 'number',
        ...
        default: undefined as number | undefined,
        description:
          'Maximum number of tokens the LLM can generate in a single response. Lower values reduce memory usage and response time. Set to 0 or undefined for model default.',
        showInDialog: true,
      },
      conciseMode: {
        type: 'boolean',
        ...
        default: false,
        description:
          'Enable concise response mode. When enabled, the LLM will provide shorter, more focused responses without unsolicited suggestions or explanations. Useful for reducing memory usage and system lag.',
        showInDialog: true,
      },
      generationConfig: {
        type: 'object',
  ...
  tools: {
    ...
    properties: {
      ...
      disabled: {
        ...
        default: [] as string[],
        description:
          'Tool names to disable (hidden from AI but shown in /tools list). Use /tools disable <name> to toggle.',
        showInDialog: false,
        mergeStrategy: MergeStrategy.UNION,
      },
      approvalMode: {
      ...
      auth: {
        ...
        properties: {
          ...
          activeProvider: {
            ...
            requiresRestart: false,
            default: undefined as string | undefined,
            description: 'The currently active AI provider ID.',
            showInDialog: false,
          },
          providers: {
            type: 'object',
            ...
            >,
            description:
              'API keys and configurations for multiple AI providers.',
            showInDialog: false,
            mergeStrategy: MergeStrategy.SHALLOW_MERGE,
          },
        },
  ...
  advanced: {
    ...
    properties: {
      ...
      censysApiKey: {
        ...
        default: undefined as string | undefined,
        description:
          'Personal Access Token for Censys host/certificate search. Starts with "censys_". Get your token at https://search.censys.io/account/api',
        showInDialog: true,
      },
      censysApiId: {
        type: 'string',
        label: 'Censys API ID (Legacy)',
        category: 'Advanced',
        requiresRestart: false,
        default: undefined as string | undefined,
        description:
          'Legacy API ID for Censys host/certificate search. Use censysApiKey instead for new Personal Access Tokens.',
        showInDialog: true,
      },
      censysApiSecret: {
        type: 'string',
        label: 'Censys API Secret (Legacy)',
        category: 'Advanced',
        requiresRestart: false,
        default: undefined as string | undefined,
        description:
          'Legacy API Secret for Censys host/certificate search. Use censysApiKey instead for new Personal Access Tokens.',
        showInDialog: true,
      },
      urlscanApiKey: {
        type: 'string',
        ...
        default: undefined as string | undefined,
        description:
          'API key for URLScan.io URL analysis and threat intelligence. Get your key at https://urlscan.io/user/signup',
        showInDialog: true,
      },
    },
  },
