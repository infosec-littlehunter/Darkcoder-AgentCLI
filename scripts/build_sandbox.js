...
console.log('packing @darkcoder/darkcoder ...');
const cliPackageDir = join('packages', 'cli');
rmSync(join(cliPackageDir, 'dist', 'darkcoder-*.tgz'), { force: true });
execSync(
...
console.log('packing @darkcoder/darkcoder-core ...');
const corePackageDir = join('packages', 'core');
rmSync(join(corePackageDir, 'dist', 'darkcoder-core-*.tgz'), {
  force: true,
});
execSync(
...
chmodSync(
  join(cliPackageDir, 'dist', `darkcoder-darkcoder-${packageVersion}.tgz`),
  0o755,
);
chmodSync(
  join(
    corePackageDir,
    'dist',
    `darkcoder-darkcoder-core-${packageVersion}.tgz`,
  ),
  0o755,
);
